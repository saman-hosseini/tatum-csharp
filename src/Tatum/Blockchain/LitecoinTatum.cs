...
namespace TatumPlatform.Blockchain
{
    ...
    /// Changed only Mainnet, Testnet and RegTest configurations for 
    /// PUBKEY_ADDRESS, SCRIPT_ADDRESS, SECRET_KEY, EXT_PUBLIC_KEY and EXT_SECRET_KEY
    /// </summary>
    class LitecoinTatum : NetworkSetBase
    {

        public static LitecoinTatum Instance { get; } = new LitecoinTatum();

        public override string CryptoCode => "LTC";

        private LitecoinTatum()
        {
        ...
        protected override NetworkBuilder CreateMainnet()
        {
            ...
            .SetBase58Bytes(Base58Type.PUBKEY_ADDRESS, new byte[] { 0x30 })
            .SetBase58Bytes(Base58Type.SCRIPT_ADDRESS, new byte[] { 0x32 })
            .SetBase58Bytes(Base58Type.SECRET_KEY, new byte[] { 0xB0 })
        ...
        protected override NetworkBuilder CreateTestnet()
        {
            ...
            .SetBase58Bytes(Base58Type.PUBKEY_ADDRESS, new byte[] { 0x6F })
            .SetBase58Bytes(Base58Type.SCRIPT_ADDRESS, new byte[] { 0x3A })
            .SetBase58Bytes(Base58Type.SECRET_KEY, new byte[] { 0xEF })
            .SetBase58Bytes(Base58Type.EXT_PUBLIC_KEY, new byte[] { 0x04, 0x36, 0xF6, 0xE1 })
            .SetBase58Bytes(Base58Type.EXT_SECRET_KEY, new byte[] { 0x04, 0x36, 0xEF, 0x7D })
